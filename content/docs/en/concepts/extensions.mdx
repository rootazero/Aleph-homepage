---
title: Extensions
description: Aleph's plugin architecture supporting WASM and Node.js runtimes, manifest-driven configuration, hook systems, background services, and channel/provider plugins.
---
